...
namespace Snake
{
    public partial class frmGame : Form
    {
        ...
        //trashcan minus points
        private List<Circle2> snake2 = new List<Circle2>();

        private Circle2 specialfood = new Circle2();
        ...
        {
            int maxYPos = (picCanvas.Size.Width / Settings.width);
            int maxXPos = (picCanvas.Size.Width / Settings.height);

            Random random1 = new Random();
            specialfood = new Circle2()
            {
                x = random1.Next(0, maxXPos),
                y = random1.Next(0, maxYPos)
            };
        ...
        {
            string msg = "This C# implementation of Snake was developed by Sushi Takahashi, ";
            msg += "from May 2, 2023 to May 27, 2023.";
            msg += "\nCoded in C# in Visual Studio 2022.";
